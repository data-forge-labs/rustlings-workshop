...
- **[Project 3: TicketV1](../02-Ownership/3-TicketV1/README.md)** — Ownership, borrowing, `struct`, `impl`
- **[Project 5: TicketV2](../02-Ownership/5-TicketV2/README.md)** — Enums, `Result`, `match`
- **[Project 6: TicketManagement](../03-Collections/6-TicketManagement/README.md)** — `HashMap`, iterators
- **[Project 8: Futures](../05-Concurrency/8-Futures/README.md)** — `async`/`.await`, Tokio runtime
- **[Project 34: DataRace](../05-Concurrency/34-DataRace/README.md)** — `Arc`, `Mutex`, `Rc`, `RefCell`
