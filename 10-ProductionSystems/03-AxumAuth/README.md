...
|---|---------|----------------|
| 1 | JWT sign & verify | One function, fails closed on bad signature |
| 2 | Bearer extraction | Parse `Authorization` header |
| 3 | Typed claims | Compile-time field validation |
| 4 | Role-based access | Pure function, easy to test |
| 5 | Axum extractor | Auth runs before the handler |
| 6 | Audit logging | Structured, correlated with request |
