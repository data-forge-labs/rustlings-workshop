...
> **Advanced version** also available in [`advanced/`](./advanced/README.md) — adds `clap` CLI args, module organization (`secret.rs`, `game.rs`), and documentation. Start here first, then level up.
