...
```bash
cargo new json_stream_workshop
cd json_stream_workshop
```
...
```bash
cp "04-FileIO/06-JsonStream/workshop/src/lib.rs" src/lib.rs
cp "04-FileIO/06-JsonStream/workshop/src/main.rs" src/main.rs
```
