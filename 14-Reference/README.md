# Section 14: Reference Appendix — Quick Concept Lookup
...
- **Before a new section**: Skim the references that cover prerequisite concepts. For example, before starting Section 5 (Concurrency), review `concurrency-reference.md` and `send-sync.md`.
